...
- `buildGoModule.goModules` now sets `__structuredAttrs = true;` and `strictDeps = true;` Out-of-tree packages passing arguments incompatible with structured attributes should convert them to be compatible.
